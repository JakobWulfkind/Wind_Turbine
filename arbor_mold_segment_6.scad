...
rotate([0,0,180]) {translate ([0,175,100]){cube ([400,40,200], center = true);}}

rotate([0,0,240]) {translate ([0,175,100]){cube ([400,40,200], center = true);}}
}


rotate([0,0,300]) {translate ([0,175,100]){cube ([400,40,200], center = true);}}
}